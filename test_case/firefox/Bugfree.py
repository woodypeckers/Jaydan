...
class Bugfree(unittest.TestCase):
    ...
    def test_bugfree(self):
        ...
        driver.find_element_by_id("BugInfoView_title").send_keys("bug1")
        ...
        Select(driver.find_element_by_id("Custom_HowFound")).select_by_visible_text(u"功能测试")
        driver.find_element_by_id("Custom_OpenedBuild").clear()
        driver.find_element_by_id("Custom_OpenedBuild").send_keys("dna")
